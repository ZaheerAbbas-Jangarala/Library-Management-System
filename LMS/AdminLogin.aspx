<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="LMS.AdminLogin" %>
  ...
  <div class="wrapper">
    ...
    <form id="form2" runat="server">
      <div class="row">
        ...
        <asp:TextBox ID="txtname" runat="server" placeholder="Admin" CssClass="form-control" required="true"></asp:TextBox>
      </div>
      <div class="row">
